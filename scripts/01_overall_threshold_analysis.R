## ---------------------------
## Script name: Heat index threshold analysis among overall study population
## Author: Grace Kuiper
## Version: 08/18/2021
...
thresholds <- c(70,72,74,76,78,80,82,84,86,88,90) #These are the HI thresholds that
                                                  #will be tested.
...
saveRDS(HI_results_threshold_total,"../results/overall/threshold/HI_results_threshold_total.rds")

####Lag Day 1####
#'Repeat the above methods using exposure of interest as above vs. below HI threshold
#'on Lag Day 1; also include lagged PM2.5 as covariate in models.
for (i in 1:length(thresholds)) {
  no_outcomes <- c()
  for (j in 1:length(casecross_list)) {
...
saveRDS(HI_lag1_results_threshold_total,"../results/overall/threshold/HI_lag1_results_threshold_total.rds")
...
saveRDS(HI_lag2_results_threshold_total,"../results/overall/threshold/HI_lag2_results_threshold_total.rds")
...
saveRDS(HI_lag3_results_threshold_total,"../results/overall/threshold/HI_lag3_results_threshold_total.rds")
...
saveRDS(HI_lag4_results_threshold_total,"../results/overall/threshold/HI_lag4_results_threshold_total.rds")
...
saveRDS(HI_lag5_results_threshold_total,"../results/overall/threshold/HI_lag5_results_threshold_total.rds")
